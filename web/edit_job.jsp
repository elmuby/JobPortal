<%-- 
    Document   : edit_post
    Created on : Jan 8, 2024, 2:29:34 PM
    Author     : DELL
--%>
...
<body>
    <header class="my-header">
        ...
        <div style="position: relative; z-index: 1;">
            <p>Edit A Job</p>
            <br>
            <p style="font-size: 1.3rem;"><a href="">Home</a> / <a href="">job</a> / edit a job</p>
        </div>
    </header>
    <main>
        <section class="main-div">
            <h2 class="post_job_header">Edit A Job Posted</h2>
            <div class="inner_div">
                <form action="post_job" method="post">
                    ...
                    <br>
                    <div class="txt_feild">
                        <input name="email" placeholder="you@yourdomainname.com" type="text" required>
                        <label for="">
                    ...
                    <div class="txt_feild">
                        <!-- <input placeholder="you@yourdomainname.com" type="email" required> -->
                    ...
                    <div class="txt_feild">
                        <input name="date" placeholder="you@yourdomainname.com" type="date" required>
                        <label for="">
